                    ...
                    link: function (scope, element, attrs) {
                        ...
                        on_treeData_change = function () {
                            ...
                            add_branch_to_list = function (level, branch, visible) {
                                ...
                                // if (branch.level === 1 && branch.parentId === "root") {
                                //
                        ...
                        if (scope.treeControl != null) {
                            if (angular.isObject(scope.treeControl)) {
                                ...
                                tree.change_expand_level= function () {
                                    expand_level =  0;
                                };
                                ...
                                tree.remove_branch = function ( branch) {
                                    var parent = tree.get_parent_branch(branch);
                                        if(parent != null){
                                            ...
                                            // 这里不能使用pop()进行删除， pop()方法只会弹出最顶层的元素
                                            // parent.children.pop(branch);
                                            var index = parent.children.indexOf(branch);
                                            parent.children.splice(index, 1);

                                            parent.expanded = true;
                                        }else{
                                            scope.treeData.pop(branch);
                                        }
                                    };
