app.controller('AddZtreeCtrl', function ($modalInstance, $scope, $http, $rootScope) {
    ...
    this.submit = function () {
        $rootScope.getzTreeNode = $scope.selectNode;
        $modalInstance.dismiss('cancel');
    }
...
app.directive('treecamera', function ($http,$rootScope) {
    return {
        require: '?ngModel',
        restrict: 'A',
